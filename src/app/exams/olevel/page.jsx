      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-center gap-6">
          ...
          <div className="bg-gray-900 rounded-lg p-6 shadow-md transition transform hover:scale-105">
            ...
            <Link onClick={() => setLoading(1)}  href="/exams/olevel/m1?sub=(M1-R5) Information Technology Tools and Network Basics" className="mt-4 inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">
              {loading === 1 ? "Loading...." : "Start Now"}
            </Link>
          </div>
          ...
          <div className="bg-gray-900 rounded-lg p-6 shadow-md transition transform hover:scale-105">
            ...
            <Link onClick={() => setLoading(2)} href="/exams/olevel/m2?sub=(M2-R5) Web Designing and Publishing" className="mt-4 inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">
              {loading === 2 ? "Loading...." : "Start Now"}
            </Link>
          </div>
          ...
          <div className="bg-gray-900 rounded-lg p-6 shadow-md transition transform hover:scale-105">
            ...
            <Link onClick={() => setLoading(3)} href="/exams/olevel/m3?sub=(M3-R5) Programming and Problem Solving through Python" className="mt-4 inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">
              {loading === 3 ? "Loading...." : "Start Now"}
            </Link>
          </div>
          ...
          <div className="bg-gray-900 rounded-lg p-6 shadow-md transition transform hover:scale-105">
            ...
            <Link onClick={() => setLoading(4)} href="/exams/olevel/m4?sub=(M4-R5) Internet of Things and its Applications" className="mt-4 inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">
              {loading === 4 ? "Loading...." : "Start Now"}
            </Link>
          </div>
        </div>
      </main>

      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-center gap-6">
          ...
          <div className="bg-gray-900 rounded-lg p-6 shadow-md transition transform hover:scale-105">
            ...
            <Link href="/exams/olevel/web-designing" className="mt-4 inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">
              Start Now
            </Link>
          </div>
          ...
          <div className="bg-gray-900 rounded-lg p-6 shadow-md transition transform hover:scale-105">
            ...
            <Link href="/exams/olevel/python-programming" className="mt-4 inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">
              Start Now
            </Link>
          </div>
          ...
          <div className="bg-gray-900 rounded-lg p-6 shadow-md transition transform hover:scale-105">
            ...
            <Link href="/exams/olevel/information-technology" className="mt-4 inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">
              Start Now
            </Link>
          </div>
          ...
          <div className="bg-gray-900 rounded-lg p-6 shadow-md transition transform hover:scale-105">
            ...
            <Link href="/exams/olevel/iot-applications" className="mt-4 inline-block bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">
              Start Now
            </Link>
          </div>
        </div>

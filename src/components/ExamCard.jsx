...
export const ExamCard = ({ data }) => {
    return (
        <div >
            ...
            <div>{data?.topic && <div className='text-gray-400 text-sm font-bold pb-3 capitalize'>Topic - {data.topic}</div>}</div>
            <div>{data?.chapter && <div className='text-gray-400 text-sm font-bold pb-3 capitalize'>Chapter - {data.chapter}</div>}</div>
